...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 14, 2021 at 07:41 PM
...
(52, 'นายทดสอบ', 'ผู้อำนวยการ', 'director1', '123456', 'testadmin@gmail.com', 2, 'Active'),
...
(86, 'Test', 'HighHeadQuarter', 'test77', '123456', 'highheadquarter@localhost.com', 7, 'Active');
...
--
ALTER TABLE `choose_a_teaching`
  MODIFY `choose_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `grade_level`
  MODIFY `grade_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `login_information`
--
ALTER TABLE `login_information`
  MODIFY `master_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT for table `prepare_to_teach`
--
ALTER TABLE `prepare_to_teach`
  MODIFY `id_prepare` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `subject`
--
ALTER TABLE `subject`
  MODIFY `subject_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `weekly_summary`
  MODIFY `id_prepare_week` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `year`
--
ALTER TABLE `year`
  MODIFY `year_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
