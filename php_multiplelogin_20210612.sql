...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2021 at 10:33 AM
...
INSERT INTO `notify` (`master_id`, `username`, `email`, `code`, `token`) VALUES
(29, 'admin', 'admin@gmail.com', NULL, NULL),
(32, 'director', 'director@gmail.com', NULL, NULL),
(40, 'deputydirector', 'aaaa@aa.com', NULL, NULL),
(41, 'academicdepartment', '6110210183@psu.ac.th', NULL, NULL),
(42, 'teacher', 'f@e.com', NULL, NULL),
(44, 'we', '6110210183@psu.ac.th', NULL, NULL),
(45, 'teacher1', '6110210183@psu.ac.th', NULL, NULL),
(46, 'teacher11', 'theaterace1@gmail.co', NULL, NULL),
(47, 'teagreen', '6110210183@psu.ac.th', NULL, NULL);
...
--
ALTER TABLE `choose_a_teaching`
  MODIFY `choose_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `classroom`
--
ALTER TABLE `classroom`
  MODIFY `class_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `login_information`
  MODIFY `master_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT for table `prepare_to_teach`
--
ALTER TABLE `prepare_to_teach`
  MODIFY `id_prepare` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `subject`
--
ALTER TABLE `subject`
  MODIFY `subject_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
